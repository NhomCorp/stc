...
ALTER TABLE "categories" ADD CONSTRAINT "categories_group_id_category_groups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."category_groups"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sessions" ADD CONSTRAINT "sessions_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "sync_runs" ADD CONSTRAINT "sync_runs_source_id_sync_sources_id_fk" FOREIGN KEY ("source_id") REFERENCES "public"."sync_sources"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_sync_run_id_sync_runs_id_fk" FOREIGN KEY ("sync_run_id") REFERENCES "public"."sync_runs"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "sync_runs_sheet_name_idx" ON "sync_runs" USING btree ("sheet_name");--> statement-breakpoint
CREATE INDEX "sync_runs_status_idx" ON "sync_runs" USING btree ("status");--> statement-breakpoint
CREATE UNIQUE INDEX "tx_source_key_hash_idx" ON "transactions" USING btree ("source_sheet","source_key_hash");--> statement-breakpoint
CREATE INDEX "tx_date_idx" ON "transactions" USING btree ("tx_date");--> statement-breakpoint
CREATE INDEX "tx_status_idx" ON "transactions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "tx_customer_id_idx" ON "transactions" USING btree ("customer_id");--> statement-breakpoint
